  ...
  return (
    <>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {reasons.map((item) => (
              <article key={item.title} className="rounded-md border border-border bg-white p-8">
                ...
                <h3 className="mt-5 font-body text-lg font-semibold text-black">{item.title}</h3>
            ...
            <ul className="mt-8 space-y-4">
              {differentiators.map((point) => (
                <li key={point} className="flex items-start gap-3">
                  ...
                  <span className="text-base leading-[1.7] text-dark">{point}</span>
                </li>
              ))}
            </ul>
          </div>
          <div className="flex flex-col gap-6 lg:pt-20">
            <div className="rounded-md border-l-4 border-primary bg-light px-6 py-6">
              <Star className="h-6 w-6 text-primary" aria-hidden />
              <p className="mt-3 font-body text-lg font-semibold text-black">
            ...
            <div className="rounded-md border-l-4 border-warm bg-light px-6 py-6">
      ...
      <section className="grid lg:grid-cols-2">
        ...
        <div className="bg-warm/10 px-6 py-16 md:px-12 md:py-20">
